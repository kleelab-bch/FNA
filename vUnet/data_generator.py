...
class prediction_data_generate:
    ...
    #==================================================================================
    #==================================================================================
    def get_whole_frames(self, test_image_index_list):
        # get the namespace
        namespace = self.find_namespace() 
        namespace = [namespace[int(i)] for i in test_image_index_list] # edited by junbong 9/29/2019
    ...
    def get_img_size(self): # for training set
        ...
        for file in namespace:
            ...
            filemask = file
            if os.path.isfile(img_path + file) and file.endswith(self.img_format): # and os.path.isfile(msk_path + filemask) 
